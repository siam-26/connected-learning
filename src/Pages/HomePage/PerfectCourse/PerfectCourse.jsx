...
const PerfectCourse = () => {
  ...
  return (
    <div className="bg-info mt-10">
      <div className="w-11/12 md:w-10/12 mx-auto pt-10 md:pt-16 pb-16">
        <div className="lg:w-80 pb-8">
          <small className="text-primary font-bold pb-1">Course List</small>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-10 lg:gap-6">
          {courses &&
            courses.map((course) => (
              <div key={course.id} className="bg-white rounded-3xl">
                <div className="p-4">
                  {/* first part */}
                  ...
                  <div className="flex justify-between justify-center items-center py-4">
                    <div>
                      <h3 className="text-neutral font-bold text-xl">
                        {course.name}
                      </h3>
                    </div>
        ...
        <div className="flex justify-center mt-10">
          <button className="bg-primary rounded-full px-8 flex items-center gap-2">
            <a className="text-white font-bold text-xs md:text-sm py-2 md:py-3">View All</a>
            <span className="text-white"><BsArrowRight /></span>
          </button>
        </div>
      </div>
    </div>
