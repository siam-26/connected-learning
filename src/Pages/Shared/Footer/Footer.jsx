  ...
  return (
    <div className="flex md:hidden lg:flex w-10/12 mx-auto ">
      <footer className="lg:footer text-center lg:text-left py-10">
        <div className="lg:w-72">
          <a
            ...
            <img
              src={footerLogo}
              alt=""
              className="w-32 bg-secondary mx-auto lg:mx-0"
            />
          </a>
          ...
          <img
            src={appStoreImg}
            alt=""
            className="w-32 mx-auto lg:mx-0 py-2 lg:py-0"
          />
          <img src={googlePlayImg} alt="" className="w-32 mx-auto lg:mx-0" />
          ...
          <div>
            ...
            <div className="flex gap-2 mt-2 justify-center py-3 md:py-0">
              <div className="w-8">
        ...
        <div className="py-4 lg:py-0 form-control lg:w-80">
